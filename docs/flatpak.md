...
With Flatpak installed, install the local 1.0.19 x86_64 bundle:

```bash
flatpak install --user ./note-note-1.0.19-x86_64.flatpak
...
mkdir -p build/dist/1.0.19
flatpak build-bundle --runtime-repo=https://flathub.org/repo/flathub.flatpakrepo \
  build/flatpak/repo build/dist/1.0.19/note-note-1.0.19-x86_64.flatpak \
...
```bash
cd build/dist/1.0.19
sha256sum note-note-1.0.19-x86_64.flatpak > note-note-1.0.19-x86_64.flatpak.sha256
sha256sum --check note-note-1.0.19-x86_64.flatpak.sha256
```
